...
const TableActions = () => {
  return (
    <div className='flex justify-between py-6 px-1 rounded-lg'>
...
<div className="relative">
    ...
    <button type="submit" className="text-black absolute end-2.5 bottom-2.5 bg-shopYellow hover:bg-yellow-300 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Search</button>
</div>
</form>

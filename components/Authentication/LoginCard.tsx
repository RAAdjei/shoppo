  ...
  return (
    <div className="">
      ...
      <div className="bg-white flex flex-col items-center justify-center">
        ...
        >
          <div className="flex justify-center info w-full mt-4">
            <p className="font-nunito font-bold text-3xl">
              Welcome Back!
            </p>
          </div>
          ...
          <div className="pass-info w-full flex justify-between md:px-3">
            ...
            <div className="forgot">
              <Link href={"/reset"}>
                <p className="font-sans font-light text-sm hover:underline hover:text-shopYellow">
                  Forgot Password ?
                </p>
              </Link>
            </div>
